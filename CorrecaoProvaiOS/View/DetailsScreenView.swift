...
class DetailsScreenView: BaseView {
    ...
    override func setConstraints() {
        titleRecipe.anchor(top: safeAreaLayoutGuide.topAnchor, leading: safeAreaLayoutGuide.leadingAnchor, bottom: nil, trailing: nil, padding: .init(top: 100, left: 16, bottom: 0, right: 0), size: .init(width: 200, height: 40))
